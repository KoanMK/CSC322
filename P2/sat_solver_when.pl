...
%
% Modified by Bruce Kapron
%
%Last modified: 24/02/19
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%:- module(sat_solver, [initialise/1, sat/2, search/4]).

:- module(sat_solver, [initialise/1, sat/2]).

initialise(_).

%
% The following is not needed for basic testing of the solver, but it used with the full testing harness
%
